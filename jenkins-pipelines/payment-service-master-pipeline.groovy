// jenkins-pipelines/payment-service-master-pipeline.groovy
pipeline {
    agent any
            ...
            steps {
                script {
                    ...
                    sh """
                        ...
                        kubectl expose deployment ${IMAGE_NAME} --port=8084 --target-port=8084 -n ${KUBERNETES_NAMESPACE} --dry-run=client -o yaml | kubectl apply -f -
